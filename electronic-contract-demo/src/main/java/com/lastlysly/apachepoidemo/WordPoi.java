...
public class WordPoi {
    ...
    public static void main(String[] args) {
        ...
        String filepathString ="C:\\Users\\lastlySly\\Desktop\\临时\\wordtemplate\\1立案登记表.docx";
        String destpathString = "C:\\Users\\lastlySly\\Desktop\\write.docx";
        Map<String, String> map = new HashMap<String, String>();
        map.put("${name1}", LocalDateTime.now().toString());
        map.put("${name2}","100.00");
        map.put("${name3}","200.00");
        map.put("${name4}","300.00");
        map.put("${sex}","男");
        map.put("${age}","19");
